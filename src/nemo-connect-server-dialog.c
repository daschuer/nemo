...
void
nemo_connect_server_dialog_set_show_browse (NemoConnectServerDialog *dialog,
						gboolean                     show)
{
...
GFile *
nemo_connect_server_dialog_get_location (NemoConnectServerDialog *dialog)
{
	const char *uri;
	GFile *file = NULL;
...
static void
nemo_connect_server_dialog_response (GtkDialog *dialog,
					 int        response_id,
					 gpointer   data)
{
	GError *error;
	NemoConnectServerDialog *cs_dialog = NEMO_CONNECT_SERVER_DIALOG (dialog);
...
static gboolean
is_scheme_supported (NemoConnectServerDialog *dialog,
		     const char                  *scheme)
{
	int i;
...
static gboolean
validate_uri (NemoConnectServerDialog *dialog,
	      const char                  *uri,
	      GError                     **error)
{
...
static void
populate_supported_list (NemoConnectServerDialog *dialog)
{
...
static void
reset_example_label (NemoConnectServerDialog *dialog)
{
	char *text;
	char *uri;
	const char *schema;
...
static char *
get_selected (NemoConnectServerDialog *dialog,
...
server_list_load (NemoConnectServerDialog *dialog)
{
	...
	datadir = g_build_filename (g_get_user_config_dir (), "nemo", NULL);
		  ...
		  GBookmarkFile               *bookmarks)
{
	...
	filename = g_build_filename (g_get_user_config_dir (), "nemo", "servers", NULL);
	g_bookmark_file_to_file (bookmarks, filename, NULL);
}

static void
populate_server_list (NemoConnectServerDialog *dialog)
{
	GBookmarkFile *bookmarks;
	GtkTreeIter iter;
	char **uris;
...
static void
server_list_remove (NemoConnectServerDialog *dialog,
		    const char                  *uri)
{
	GBookmarkFile *bookmarks;
...
static void
server_list_remove_all (NemoConnectServerDialog *dialog)
{
	GBookmarkFile *bookmarks;
...
on_popup_menu_detach (GtkWidget *attach_widget,
		      GtkMenu   *menu)
{
	NemoConnectServerDialog *dialog = NEMO_CONNECT_SERVER_DIALOG (attach_widget);
...
static void
create_popup_menu (NemoConnectServerDialog *dialog)
{
	GtkWidget *menu;
	GtkWidget *item;
...
static void
history_popup_menu (NemoConnectServerDialog *dialog)
{
...
nemo_connect_server_dialog_init (NemoConnectServerDialog *dialog)
{
	...
	g_signal_connect (dialog, "response",
			  G_CALLBACK (nemo_connect_server_dialog_response),
			  NULL);
