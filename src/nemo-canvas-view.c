...
void
nemo_canvas_view_clean_up_by_name (NemoCanvasView *canvas_view)
{
...
static void
canvas_view_handle_hover (NemoCanvasContainer *container,
			  const char *target_uri,
			  NemoCanvasView *view)
{
	nemo_view_handle_hover (NEMO_VIEW (view), target_uri);
}
...
nemo_canvas_view_init (NemoCanvasView *canvas_view)
{
	...
	g_signal_connect_object (get_canvas_container (canvas_view), "handle-netscape-url",
				 G_CALLBACK (canvas_view_handle_netscape_url), canvas_view, 0);
	g_signal_connect_object (get_canvas_container (canvas_view), "handle-uri-list",
				 G_CALLBACK (canvas_view_handle_uri_list), canvas_view, 0);
	g_signal_connect_object (get_canvas_container (canvas_view), "handle-text",
				 G_CALLBACK (canvas_view_handle_text), canvas_view, 0);
	g_signal_connect_object (get_canvas_container (canvas_view), "handle-raw",
